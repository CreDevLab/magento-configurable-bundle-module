 ...
 */
class Composite extends \Magento\Backend\Block\Widget implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    /**
     * @var mixed
     */
    ...
    {
        return $this->getUrl('adminhtml/composite_product_edit/form', ['_current' => true]);
    }
    ...
    protected function _prepareLayout()
    {
        ...
        $this->setChild(
            ...
            $this->getLayout()->createBlock(
                \Credevlab\Composite\Block\Adminhtml\Catalog\Product\Edit\Tab\Bundle\Option::class,
