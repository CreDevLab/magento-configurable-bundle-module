 ...
 */
namespace Credevlab\ConfigurableBundle\Controller\Adminhtml\Bundle\Product\Edit;
    ...
    public function execute()
    {
        ...
        $this->getResponse()->setBody(
            $this->_view->getLayout()->createBlock(
                \Credevlab\ConfigurableBundle\Block\Adminhtml\Catalog\Product\Edit\Tab\Bundle::class,
