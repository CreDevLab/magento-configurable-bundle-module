...
/**
 * Create Ship Bundle Items and Affect Composite Product Selections fields
 * @SuppressWarnings(PHPMD.CouplingBetweenObjects)
 */
class CompositePanel extends AbstractModifier
{
    const GROUP_CONTENT = 'content';
    const CODE_SHIPMENT_TYPE = 'shipment_type';
    const CODE_COMPOSITE_DATA = 'bundle-items';
    const CODE_AFFECT_COMPOSITE_PRODUCT_SELECTIONS = 'affect_composite_product_selections';
    const CODE_COMPOSITE_HEADER = 'bundle_header';
    const CODE_COMPOSITE_OPTIONS = 'bundle_options';
    const SORT_ORDER = 20;
    ...
    public function modifyMeta(array $meta)
    {
        ...
        $path = $this->arrayManager->findPath(static::CODE_COMPOSITE_DATA, $meta, null, 'children');
            ...
            [
                ...
                'children' => [
                    'modal' => [
                                    ...
                                    'options' => [
                                        ...
                                        'buttons' => [
                                            ...
                                            [
                                                ...
                                                'actions' => [
                                                    [
                                                        'targetName' => 'index = composite_product_listing',
                                                        'actionName' => 'save'
                                                    ],
                                                    'closeModal'
                                                ],
                        ...
                        'children' => [
                            'composite_product_listing' => [
                                'arguments' => [
                                    'data' => [
                                        'config' => [
                                            'autoRender' => false,
                                            'componentType' => 'insertListing',
                                            'dataScope' => 'composite_product_listing',
                                            'externalProvider' =>
                                                'composite_product_listing.composite_product_listing_data_source',
                                            'selectionsProvider' =>
                                                'composite_product_listing.composite_product_listing.product_columns.ids',
                                            'ns' => 'composite_product_listing',
                    ...
                    self::CODE_AFFECT_COMPOSITE_PRODUCT_SELECTIONS => [
                        'arguments' => [
                            'data' => [
                                'config' => [
                                    ...
                                    'dataScope' => 'data.affect_composite_product_selections',
                                    'visible' => false,
                                    'value' => '1'
                                ],
                            ],
                    ...
                    self::CODE_COMPOSITE_HEADER => $this->getBundleHeader(),
                    self::CODE_COMPOSITE_OPTIONS => $this->getBundleOptions()
                ]
            ]
        );
                                ...
                                'actions' => [
                                    [
                                        'targetName' => 'product_form.product_form.'
                                            . self::CODE_COMPOSITE_DATA . '.' . self::CODE_COMPOSITE_OPTIONS,
        ...
        return [
            'arguments' => [
                'data' => [
                    'config' => [
                        'componentType' => Container::NAME,
                        'component' => 'Credevlab_Composite/js/components/bundle-dynamic-rows',
                    ...
                    'arguments' => [
                        'data' => [
                            'config' => [
                                ...
                                'positionProvider' => 'product_composite_container.position',
                                'imports' => [
                                    'label' => '${ $.name }' . '.product_composite_container.option_info.title:value'
                                ],
                            ],
                        ],
                    ],
                    'children' => [
                        'product_composite_container' => [
                            'arguments' => [
                                'data' => [
                                    'config' => [
                                ...
                                'composite_selections' => [
                                    'arguments' => [
                                        'data' => [
                                            'config' => [
                                                'componentType' => Container::NAME,
                                                'component' => 'Credevlab_Composite/js/components/bundle-dynamic-rows-grid',
                                                'sortOrder' => 50,
                                                'additionalClasses' => 'admin__field-wide',
                                                'template' => 'ui/dynamic-rows/templates/default',
                                                'provider' => 'product_form.product_form_data_source',
                                                'dataProvider' => '${ $.dataScope }' . '.cp,[psote_button_proxy',
            ...
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'actions' => [
                            [
                                'targetName' => 'product_form.product_form.' . static::CODE_COMPOSITE_DATA . '.modal',
                                'actionName' => 'toggleModal'
                            ],
                            [
                                'targetName' => 'product_form.product_form.' . static::CODE_COMPOSITE_DATA
                    ...
                    'arguments' => [
                        'data' => [
                            'config' => [
                                ...
                                'parentContainer' => 'product_composite_container',
                                'selections' => 'composite_selections',
            ...
            'children' => [
                    ...
                    'arguments' => [
                        'data' => [
                            'config' => [
                                'formElement' => Form\Element\Checkbox::NAME,
                                'componentType' => Form\Field::NAME,
                                'component' => 'Credevlab_Composite/js/components/bundle-checkbox',
                                'parentContainer' => 'product_composite_container',
                                'parentSelections' => 'composite_selections',
                ...
                'selection_qty' => [
                    'arguments' => [
                        'data' => [
                            'config' => [
                                'component' => 'Credevlab_Composite/js/components/bundle-option-qty',
                                'formElement' => Form\Element\Input::NAME,
                                'componentType' => Form\Field::NAME,
                                'dataType' => Form\Element\DataType\Number::NAME,
                    ...
                    'arguments' => [
                        'data' => [
                            'config' => [
                                ...
                                'component' => 'Credevlab_Composite/js/components/bundle-user-defined-checkbox',
            ...
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'value' => '0.00',
                        'imports' => [
                            'visible' => '!ns = ${ $.ns }, index = ' . CompositePrice::CODE_PRICE_TYPE . ':checked'
                        ],
                        'sortOrder' => 80,
                    ],
                ],
